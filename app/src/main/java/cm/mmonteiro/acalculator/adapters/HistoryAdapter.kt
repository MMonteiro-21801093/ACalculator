...
class HistoryAdapter(private val context: Context,private val layout: Int,private val items:
MutableList<Operation>,private val histListener: HistoryInterface)  : RecyclerView.Adapter<HistoryAdapter.HistoryViewHolder>()
      {
